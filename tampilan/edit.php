...
<html lang="en">
  ...
  <h1>Edit Berita</h1>
    ...
    <form action="../proses/proses_edit.php" method="POST" enctype="multipart/form-data">
      <input type="hidden" name="id" value="<?=$isinya["id"];?>">
      <input type="hidden" name="thumbnaillama" value="<?=$isinya["thumbnail"];?>">
      <label for="judul">judul</label>
      <input type="text" name="judul" class="form-control"value="<?= $isinya["judul"];?>" required>
      <label for="deskripsi">deskripsi</label>
      <input type="text" name="deskripsi" class="form-control" value="<?= $isinya["deskripsi"];?>" required>
      <label for="isi">isi</label>
      <textarea name="isi"  cols="30" rows="20" class="form-control" required><?= $isinya["isi"];?></textarea>
      <label for="thumbnail">thumbnail</label>
      <br>
      <img src="../thumbnail/<?=$isinya["thumbnail"]?>" alt="" class="rounded-circle" style="width:200px; height:200px;">
      <br> <br>
      <input type="file" name="thumbnail" class="form-control">
      <button type="submit" name="edit" class="btn btn-danger mt-3">Edit data</button>
